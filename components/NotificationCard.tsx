...
const getTypeIcon = (type: NotificationType) => {
  switch (type) {
    case NotificationType.ORDER_UPDATE:
      return <FaShoppingCart className="text-brand-red" />;
...
const getPriorityBadge = (priority: NotificationPriority) => {
  const priorityStyles = {
    ...
    [NotificationPriority.NORMAL]: 'bg-red-100 text-red-600 border-red-300',
...
const NotificationCard: React.FC<NotificationCardProps> = ({
  ...
  return (
    <div className={`
      ...
      ${isSelected ? 'ring-2 ring-brand-red border-brand-red' : ''}
    `}>
      <div className="flex items-start space-x-3">
        ...
        <div className="flex items-center pt-1">
          <input
            ...
            className="w-4 h-4 text-brand-red bg-gray-100 border-gray-300 rounded focus:ring-brand-red focus:ring-2"
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-start justify-between mb-2">
            <div className="flex items-center space-x-2 flex-1">
              ...
              {!notification.isRead && (
                <div className="w-2 h-2 bg-brand-red rounded-full flex-shrink-0" aria-label="Unread notification" />
              )}
            </div>
            ...
            <div className="flex items-center space-x-2">
              {!notification.isRead && (
                <button
                  ...
                  className="inline-flex items-center px-2 py-1 text-xs font-medium text-brand-red bg-red-100 rounded hover:bg-red-200 focus:outline-none focus:ring-2 focus:ring-brand-red focus:ring-offset-1 transition-colors"
